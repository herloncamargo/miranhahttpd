...
key={title}
    ...
    return (
        <div>
            ...
            { "\n" }
            <Button
variant="secondary" onClick={() => zoom_state.zoom_out()}
            ...
            { "\n" }
            <Button
variant="secondary" onClick={() => zoom_state.scroll_left()}
                    isDisabled={!zoom_state.enable_scroll_left}
            >
                <AngleLeftIcon />
            </Button>
            <Button
variant="secondary" onClick={() => zoom_state.scroll_right()}
...
width={w} height={h}
            ...
            >
                ...
                <rect
x={m_left} y={m_top} width={w - m_left - m_right} height={h - m_top - m_bottom}
                      className="ct-plot-border"
                />
                { y_ticks.unit && <text
x={m_left - tick_length - tick_gap} y={0.5 * m_top}
...
key={i}
                ...
                { selection &&
                <rect
x={selection.left} y={m_top} width={selection.right - selection.left} height={h - m_top - m_bottom}
